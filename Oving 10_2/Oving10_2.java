...
public class Oving10_2 {
    public static void main(String[] args) {
        ...
        Rett a1 = new Rett(1, "John Mayer", "Oslo Spektrum", "JM Productions", "Konsert", 201910032000L);
        Rett a2 = new Rett(2, "John Mayer", "Trondheim Spektrum", "JM Productions", "Konsert", 201910042000L);
        Rett a3 = new Rett(3, "Hawaiitur", "Oahu, Hawaii", "Familytrips", "Reise", 201912211000L);
        Rett a4 = new Rett(4, "Botfest", "Der det skjer", "Tihlde Pythons", "Botfest", 202001022200L);
        Rett a5 = new Rett(5, "Julebord", "Rockheim", "Tihlde", "Sosialt", 201911212000L);
        ...
        String[]muligheter = {"Finn oppskrift", "Forretter", "Hovedretter", "Desserter", "Alle menyer", "Menyer git prisintervall", "Avslutt"};
